...
// TODO: Uncomment based on whether it is French data or English
const getData = (region) => data[region];
// const getData = (region) => dataFr[region];
...
const displayStores = (region, ...keywords) => {
  ...
  const dataDisplay = filteredPayload
    .map((object) => {
      ...
      // TODO: Un-comment depending on using French or English data.
      return `
