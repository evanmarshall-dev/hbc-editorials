...
// const compiled_js =
//   getAutoBanner() + "-" + config.project.name + "-" + config.project.pubdate + "-main-" + version + ".js";
// const compiled_css =
//   getAutoBanner() + "-" + config.project.name + "-" + config.project.pubdate + "-main-" + version + ".css";
...
//   switch (banner) {
//     case "bay":
//       stagingBase = `https://stage.thebay.com/editorial/${config.project.name.toLowerCase()}?__siteDate=${config.project.pubdate
//         .replace("-", "")
//         .replace("-", "")}0000`; //SalesForce
//       break;
//   }
...
//   switch (banner) {
//     case "bay":
//       stagingBase = `https://www.thebay.com/editorial/${config.project.name}`.toLocaleLowerCase(); //SalesForce
//       break;
//   }
...
//   return (
//     prefix +
//     config.project.bayID +
//     "-" +
//     config.project.pubdate +
//     "-" +
//     config.project.name +
//     "-" +
//     fileNameNoExt +
...
//   return `
//         <picture>
//             <source media="(max-width: 1024px)" srcset="${getImageUrl(fileName + "." + fileExt, outputType)}">
...
//   return (
//     gulp
//       .src(["./src/html/template/header.html", "./src/main_EN.html", "./src/html/template/footer.html"])
...
//   return (
//     gulp
//       .src(["./src/html/template/header.html", "./src/main_FR.html", "./src/html/template/footer.html"])
//       .pipe(plugin.concat("index.html"))
//       .pipe(
//         plugin.data(() => {
//           return {
...
//   } else {
//     return gulp
//       .src("./src/js/_libs/_dev/empty.js")
//       .pipe(plugin.concat("_com-libs.js"))
...
//     )
//     .pipe(
//       plugin.appendPrepend.prependText(
...
//   return gulp
//     .src(["./bin/_com-libs.js", "./bin/_com-app.js"])
//     .pipe(
//       plugin.concat(
//         getAutoBanner() + "-" + config.project.name + "-" + config.project.pubdate + "-main-" + version + ".js"
//       )
...
//     .pipe(
//       plugin.rename({
//         prefix: config.project.bayID + "-" + config.project.pubdate + "-" + config.project.name + "-",
//       })
//     )
...
//             returnedValues += getScene7URL() + (getFileName(files[i]) + "?scl=1&qlt=75&fmt=webp" + "\n");
//           }
//         }
...
// const nodeClean = () => {
//   return del(["node_modules", "./package-lock.json", "./yarn.lock"]);
// };
